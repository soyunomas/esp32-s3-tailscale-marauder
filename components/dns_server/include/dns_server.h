...
/**
 * @brief Switch between captive redirect responses and DNS forwarding.
 *
 * When forwarding is enabled, queries received by this local DNS server are
 * proxied to the current lwIP upstream DNS server.
 */
